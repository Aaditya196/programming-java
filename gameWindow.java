...
public class gameWindow extends JFrame implements ActionListener {
    ...
    String word [] = {"JAPAN","INDIA","AMERICA","RUSSIA","CHINA","AFGHANISTAN","ENGLAND","PAKISTAN","CANADA","BAHARAIN"};
    Random rd;
    StringBuffer blanks ;
    ...
    public void actionPerformed(ActionEvent ae) {
        ...
        if(chance>5){
            JOptionPane.showMessageDialog(this, "Sorry you lost the chances");
            int n = JOptionPane.showConfirmDialog(this,"Do you want to play again ?","Restart Game",JOptionPane.YES_NO_OPTION,JOptionPane.QUESTION_MESSAGE);
